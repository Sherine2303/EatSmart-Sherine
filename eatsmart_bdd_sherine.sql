...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 sep. 2025 à 23:40
...
--
-- Base de données : `eatsmart_bdd_sherine`
--
CREATE DATABASE IF NOT EXISTS `eatsmart_bdd_sherine` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `eatsmart_bdd_sherine`;
